# Aplicación Venta de Viajes JavaScript

Link para ver resultado: [VENTA VIAJES FINALIZADO](https://proyecto-viajes-javascript.netlify.app/)
...
## Creditos 
[basado en VIDEO CURSO GRATIS COMPLETO: JavaScript Desde Cero por Sergie Code](https://youtu.be/N8Xt5rP_DUo)
...
Puedes personalizar el contenido de las ciudades modificando el archivo `ciudades.js`. Cada ciudad es representada por un objeto con propiedades como `titulo`, `subtitulo`, `imagen` `parrafo` y `precio`.
